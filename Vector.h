 ...
 *
 * @warning VECTOR_UNINITIALIZED_ERROR if vector is NULL
 * @warning VECTOR_OVERFLOW_ERROR if vector is full and block size is 0
 * @warning VECTOR_REALLOCATION_ERROR if reallocation failed
 */
 ...
 *
 * @warning VECTOR_UNINITIALIZED_ERROR if vector is NULL
 * @warning VECTOR_INDEX_OUT_OF_BOUNDS_ERROR if index out of correct range
 */
